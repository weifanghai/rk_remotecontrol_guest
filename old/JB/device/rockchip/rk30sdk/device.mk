...
#  tuzi: tuzi.apk
########################################################
rk_apps_files := $(shell ls $(LOCAL_PATH)/apk/tuzi | grep .apk)
PRODUCT_COPY_FILES += $(foreach file, $(rk_apps_files), \
        $(LOCAL_PATH)/apk/tuzi/$(file):system/app/$(file))

########################################################
#  tuzi apk: libtuzi_core.so
########################################################
PRODUCT_COPY_FILES += $(LOCAL_PATH)/apk/tuzi/libtuzi_core.so:system/lib/libtuzi_core.so
